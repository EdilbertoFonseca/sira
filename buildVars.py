...
addon_info = AddonInfo(
	...
	addon_summary=_("SIRA - Internal System for Extensions and Notes"),
	# Add-on description
	...
	addon_changelog=_("""Fixed an issue where formatting was not correctly applied when pasting numbers into a phone field without an area code."""),
	# Author(s)
	addon_author="Edilberto Fonseca <edilberto.fonseca@outlook.com>",
	# URL for the add-on documentation support
	addon_url="http://github.com/edilberto/sira",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="http://github.com/edilberto/sira",
